      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-4 md:mb-8">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          <button
            ref={nextRef}
            aria-label="Next"
            className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-300 hover:text-white hover:bg-white/10 hover:border-pink-500/30 transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="relative group w-full h-full flex flex-col">
                ...
                <div
                  className={`flex-1 w-full flex flex-col items-center justify-center text-center p-3 md:p-6 rounded-2xl transition-all duration-300 border ${item.active
                    ...
                    : 'bg-[#0b131b]/80 border-white/5 hover:border-pink-500/30 hover:bg-[#0f1720]'
                    }`}
                >
